...
struct WishSealingInspirationService {
    ...
    private func aiInspiration(
        ...
        Ограничения:
        - русский язык.
        - message: 2 коротких вдохновляющих предложения, мистично и тепло, но без гарантии исполнения.
        - planSummary: только если isPlan=true, 1 предложение с сутью плана.
        - recommendation: только если isPlan=true, 1-2 предложения с реалистичным следующим шагом.
    ...
    private func fallbackInspiration(title: String, intention: String, feeling: String) -> WishSealingInspiration {
        ...
        return WishSealingInspiration(
            message: "В этом желании уже слышен не только свет, но и маршрут. Капсула сохранила намерение, а ближайшие дни могут превратить его в первые настоящие следы.",
            planSummary: "Похоже, это желание можно разложить на несколько спокойных шагов.",
            recommendation: "Начни с самого маленького действия, которое можно сделать без идеальных условий: уточнить следующий шаг, выбрать время и оставить себе видимый знак.",
            checkpoints: [
